...
#Run the Recipe List
/usr/local/bin/autopkg run -k DISABLE_CODE_SIGNATURE_VERIFICATION=1 --recipe-list /Volumes/JAMF/AutoPkg/RecipeRepos/com.github.litmus.jamf-recipes/recipe_list.plist
